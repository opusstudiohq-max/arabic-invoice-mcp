...
2. **دقة وصحة المدخلات**:
   - لضمان التوافق التام مع هيئة الزكاة والضريبة والجمارك (ZATCA) في السعودية، يتم فرض قواعد تحقق صارمة على المدخلات الأساسية؛ الرقم الضريبي للبائع يجب أن يكون 15 رقماً ويبدأ وينتهي بالرقم 3، والتواريخ يجب أن تتبع تنسيق ISO 8601 بدقة.
